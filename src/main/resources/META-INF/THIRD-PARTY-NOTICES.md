...
This binary bundles Jackson 2.22.1 (Apache-2.0), Mozilla Rhino 1.9.1 (MPL-2.0)
and selected JavaScript files from FIRST's official CVSS v4.0 reference
calculator (BSD-2-Clause, exact license in `LICENSE-FIRST-CVSS.txt`). Rhino's
license is in `LICENSE-RHINO-MPL-2.0.txt`. PortSwigger
...
https://github.com/sr-maximus/Burp-Framework-Mapper.
